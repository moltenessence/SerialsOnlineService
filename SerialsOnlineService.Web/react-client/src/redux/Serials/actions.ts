...
export type SetRatingsAction = { type: typeof SET_RATINGS, payload: ISerialRatings };
...
export const setRatings = (ratings: ISerialRatings): SetRatingsAction => ({ type: SET_RATINGS, payload: ratings });